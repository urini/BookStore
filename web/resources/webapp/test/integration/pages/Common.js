sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/sap/books/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("com.sap.books.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/sap/books/localService/mockserver"], function (mockserver) {
