				...
				actions : {
							...
							success : function (aEntityData) {
								this.waitFor({
									...
									success : function (oList) {
										...
										oCurrentItem.bindingPath = "/" + oList.getModel().createKey("booksales", {
											ID : sCurrentId
										});
					...
					iRememberTheListItem : function (oListItem) {
						...
						this.getContext().currentItem = {
							...
							title: oBindingContext.getProperty("BookName")
						};
					}
				},
				...
				assertions : {
					...
					theListHeaderDisplaysZeroHits : function () {
						return this.waitFor({
							viewName : sViewName,
							id : "page",
							matchers : new PropertyStrictEquals({name : "title", value : "booksales (0)"}),
							success : function () {
								Opa5.assert.ok(true, "The list header displays 'booksales (0)'");
							},
					...
					theListShouldBeSortedAscendingOnName : function () {
						return this.theListShouldBeSortedAscendingOnField("BookName");
					},
					...
					theListShouldHaveAllEntries : function () {
						...
						// retrieve all booksales to be able to check for the total amount
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								this.waitFor({
									id : "page",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name : "title", value : "booksales (" + iExpectedLength + ")"}),
									success : function () {
