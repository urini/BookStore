sap.ui.define([
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("BookName").length, 1, "The sorting by BookName returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by BookName and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "Price");

		this.oGroupSortState.sort("BookName");
