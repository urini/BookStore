sap.ui.define([
	...
	return BaseObject.extend("com.sap.books.model.GroupSortState", {
		 ...
		 * @alias com.sap.books.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "Price") {
				...
				this._oViewModel.setProperty("/sortBy", "BookName");
			}
